/**
 * FusionCharts: Flash Player detection and Chart embedding. Version: 1.2.3
 * (15th September, 2008) - Added fix for % and & characters. Additional fixes
 * to properly handle double quotes and single quotes in setDataXML() function.
 * Version: 1.2.2 (10th July, 2008) - Added fix for % scaled dimensions, fixes
 * in setDataXML() and setDataURL() functions Version: 1.2.1 (21st December,
 * 2007) - Added setting up transparent/opaque mode: setTransparent() function
 * Version: 1.2 (1st November, 2007) - Added FORM fixes for IE Version: 1.1
 * (29th June, 2007) - Added Player detection, New conditional fixes for IE
 * 
